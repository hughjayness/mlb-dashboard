  ...
  try {
    ...
    return res.status(200).json({
      ...
      notes: [
        ...
        "Use the debug block on each game to determine whether 0.00 drivers are real neutral scores or missing-data fallbacks.",
        "Once verified, the debug block can be removed."
      ],
      games
    });
  } catch (error) {
