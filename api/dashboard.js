module.exports = async function handler(req, res) {
  ...
  // The Odds API wants YYYY-MM-DDTHH:MM:SSZ with no milliseconds
  ...
  try {
    ...
    return res.status(200).json({
      ...
      notes: [
        ...
        "Pitcher, bullpen, lineup, defense, weather, and travel are placeholder-neutral until those feeds are connected.",
        "Fair prices, edge, timing, and stake outputs are active now."
      ],
      games: games
    });
  } catch (error) {
