...
function buildComponentScores({
  ...
  return {
    ...
    liveFeedStatus: {
      ...
      offenseVsHand: homeTeamStats.hitting && Object.keys(homeTeamStats.hitting).
length ? "live" : "missing",
      defense: "missing",
...
function buildRecommendation({
  ...
  if (typeof firstFiveModelOutputs.homeEdgePct === "number" && shouldIncludeFirstFiveSideCandidate("home", firstFiveLogic, firstFiveModelOutputs, firstFiveData, componentScores)) {
    gameCandidates.push({
  ...
  if (typeof firstFiveModelOutputs.awayEdgePct === "number" && shouldIncludeFirstFiveSideCandidate("away", firstFiveLogic, firstFiveModelOutputs, firstFiveData, componentScores)) {
    gameCandidates.push({
  ...
  if (typeof firstFiveModelOutputs.overEdgePct === "number" && shouldIncludeFirstFiveTotalCandidate(firstFiveLogic, firstFiveModelOutputs, firstFiveData, componentScores)) {
    gameCandidates.push({
  ...
  if (typeof firstFiveModelOutputs.underEdgePct === "number" && shouldIncludeFirstFiveTotalCandidate(firstFiveLogic, firstFiveModelOutputs, firstFiveData, componentScores)) {
    gameCandidates.push({
